...
function createTaskItemElement(task) {
  ...
  newLiElem.textContent = task.description;
  ...
  if(task.complete) {
    newLiElem.classList.add("font-strike");
  } else {
    if (newLiElem.classList.contains("font-strike")) {
      newLiElem.classList.remove("font-strike");
    }
  }
  return newLiElem;
}
